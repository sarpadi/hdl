...
8-channel, simultaneously sampling, Σ-Δ ADC. The AD7768-1 provides a single
...
impulse response (FIR) digital filter at 256 kSPS, giving 110.8 kHz input
...
-  :git-hdl:`ad7768-1 HDL project source code <projects/ad77681evb>`
