...
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS25} [get_ports ad3552r_spi_sdo]       ; ##  LA02_P
#set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS25} [get_ports ad3552r_spi_sdio[0]]       ; ##  LA02_P
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS25} [get_ports ad3552r_spi_sdi]       ; ##  LA02_N
